        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
          ...
                    </div>
                    ...
                    <div class="bg-white hover-effect p-6 rounded-lg shadow-sm border border-gray-200">
                        ...
                        <a href="{{ route('trabajador.show') }}" class="bg-orange-500 text-white px-4 py-2 rounded shadow hover:bg-yellow-600 transition">
                            Ingresar
                        </a>
                    </div>
                    ...
                    <div class="bg-white hover-effect p-6 rounded-lg shadow-sm border border-gray-200">
                        ...
                        <a href=" " class="bg-orange-500 text-white px-4 py-2 rounded shadow hover:bg-yellow-600 transition">
                            Generar Reporte
                        </a>
                    </div>
                    ...
                    <div class="bg-white hover-effect p-6 rounded-lg shadow-sm border border-gray-200">
                        ...
                        <a href="{{ route('trabajador.solicitudes') }}" class="bg-orange-500 text-white px-4 py-2 rounded shadow hover:bg-yellow-600 transition">
                            Consultar
                        </a>
                    </div>
                    ...
                    <div class="bg-white hover-effect p-6 rounded-lg shadow-sm border border-gray-200">
                        ...
                        <a href="{{ route('trabajador.reclamo.create') }}" class="bg-orange-500 text-white px-4 py-2 rounded shadow hover:bg-yellow-600 transition">
                            Registrar
                        </a>
                    </div>
